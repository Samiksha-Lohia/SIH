...
const styles = {
  ...
  searchInput: { flex: 1, maxWidth: '360px', padding: 'var(--space-2) var(--space-3)', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border)', fontSize: 'var(--font-size-sm)', backgroundColor: 'var(--color-bg-surface)' },
  ...
  cardsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: 'var(--space-4)' },
  roleCard: { display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' },
  cardHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' },
  cardActions: { display: 'flex', gap: 'var(--space-1)' },
  roleDesc: { fontSize: 'var(--font-size-xs)', color: 'var(--color-text-secondary)', lineHeight: '1.4' },
  skillsSection: { marginTop: 'auto', paddingTop: 'var(--space-2)', borderTop: '1px solid var(--color-border-subtle)' },
  skillsHeader: { marginBottom: 'var(--space-2)' },
  sectionLabel: { fontSize: 'var(--font-size-xs)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.04em' },
  skillsChipsWrap: { display: 'flex', flexWrap: 'wrap', gap: '6px' },
  skillItem: { display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '3px 8px', borderRadius: 'var(--radius-sm)', backgroundColor: 'var(--color-mist-light)', border: '1px solid var(--color-border)', fontSize: '11px' },
  ...
  modalCardLarge: { maxWidth: '640px', width: '100%', maxHeight: '90vh', overflowY: 'auto' },
  ...
  formRow: { display: 'flex', gap: 'var(--space-3)' },
